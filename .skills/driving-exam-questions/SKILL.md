...
- **Endpoint**: `POST https://app-bloui2v2mnsx-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query`
...
async function queryDrivingExamQuestions(
  ...
  const response = await fetch(
    `https://app-bloui2v2mnsx-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query?${params.toString()}`,
    {
      method: "POST",
      headers: {

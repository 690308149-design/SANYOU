...
| Endpoint | `POST https://app-bloui2v2mnsx-api-2Y00V8pRRoxY-gateway.appmiaoda.com/caipiao/winning` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-bloui2v2mnsx-api-2Y00V8pRRoxY-gateway.appmiaoda.com` |
...
async function queryCaipiaoWinning(
  ...
  const url =
    `https://app-bloui2v2mnsx-api-2Y00V8pRRoxY-gateway.appmiaoda.com/caipiao/winning?${params.toString()}`;

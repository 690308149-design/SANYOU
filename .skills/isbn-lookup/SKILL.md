...
- **Endpoint**：`POST https://app-bloui2v2mnsx-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bloui2v2mnsx-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
